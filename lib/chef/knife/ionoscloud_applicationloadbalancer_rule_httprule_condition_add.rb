...
class Chef
  class Knife
    class IonoscloudApplicationloadbalancerRuleHttpruleConditionAdd < Knife
      include Knife::IonoscloudBase

      banner 'knife ionoscloud applicationloadbalancer rule httprule condition add (options)'
