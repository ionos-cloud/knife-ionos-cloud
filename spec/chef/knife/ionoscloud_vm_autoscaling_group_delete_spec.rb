require 'spec_helper'
require 'ionoscloud_vm_autoscaling_group_delete'

Chef::Knife::IonoscloudVmAutoscalingGroupDelete.load_deps

describe Chef::Knife::IonoscloudVmAutoscalingGroupDelete do
  before :each do
    subject { Chef::Knife::IonoscloudVmAutoscalingGroupDelete.new }
