...
Chef::Knife::IonoscloudAutoscalingGroupCreate.load_deps

describe Chef::Knife::IonoscloudAutoscalingGroupCreate do
  before :each do
    subject { Chef::Knife::IonoscloudAutoscalingGroupCreate.new }
