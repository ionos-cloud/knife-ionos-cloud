require 'spec_helper'
require 'ionoscloud_autoscailing_server_get'

Chef::Knife::IonoscloudAutoscailingGrouServerpGet.load_deps

describe Chef::Knife::IonoscloudAutoscailingGrouServerpGet do
  before :each do
    subject { Chef::Knife::IonoscloudAutoscailingGrouServerpGet.new }
    ...
    it 'should call AutoscailingApi.autoscaling_groups_servers_find_by_id' do
      ...
      mock_dbaas_call_api(
        ...
        [
          {
            method: 'GET',
            path: "/autoscaling/groups/#{subject_config[:group_id]}/servers//#{subject_config[:server_id]}",
