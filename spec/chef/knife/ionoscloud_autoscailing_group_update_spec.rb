require 'spec_helper'
require 'ionoscloud_autoscailing_group_update'

Chef::Knife::IonoscloudAutoscailingGroupUpdate.load_deps

describe Chef::Knife::IonoscloudAutoscailingGroupUpdate do
  before :each do
    subject { Chef::Knife::IonoscloudAutoscailingGroupUpdate.new }
